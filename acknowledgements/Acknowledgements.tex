...
%The neural-network models were developed with resources from WLCG, Techlab
%(CERN) and from Advanced High-Performance Computational Center (NACAD) at
%COPPE/UFRJ.\@ The crucial computing support from all partners is acknowledged
%gratefully. Financial support has been also provided by CAPES, CNPq, RENAFAE
%(MCTIC) and FAPERJ (Brazil). The illustration in Figure~\ref{fig:calo_rings} was
%greatly improved and kindly updated to match ATLAS standards by Marton S.\@ dos
%Santos. In addition, we do acknowledge Ryan Mackenzie White, former ATLAS
%collaborator, for his helpful insights and advices during the \rnn{} development
%for Run~2. Many interesting comments by Alessandro Tricoli in a previously
%unpublished note provided further insights for the edition of this note.
%Finally, contributions from the Egamma Trigger Group conveners during Run~2 were
%essential in the development of this work, specially Fernando Monticelli, Tanya
%(Tetiana) Hryn'Ova, Arantxa (Aranzazu) Ruiz Martinez and Moritz Backes.
