...
%-------------------------------------------------------------------------------
\documentclass[NOTE, atlasdraft=true, UKenglish]{latex/atlasdoc}
...
\input{ANA-TRIG-2021-01-INT1-metadata}
...
\include{sections/introduction/introduction} % ok
\include{sections/context/context} % need to fix tables and alg
\include{sections/ringer/ringer} % need to fix table and alg
\include{sections/operation/operation} % ok
\include{sections/analyses/analyses} % ok
%\include{sections/other_studies/other_studies} % ok
\include{sections/conclusion/conclusion} % ok
...
%\include{appendices/compint}
%\include{appendices/2017_selection}
%\include{appendices/crossval}
%\include{appendices/tuning_workflow}
%\include{appendices/datasets}
%\include{appendices/2017_challenges}
%\include{appendices/supplementary_studies}
%\include{sections/low_et}
%\include{appendices/auxmat}
%-------------------------------------------------------------------------------
